...
void Dup(u32 method, Task *orig_task, std::vector<LPointer<Task>> &dups) override {
  switch (method) {
    ...
    case Method::kRegisterStager: {
      labstor::CALL_DUPLICATE(reinterpret_cast<RegisterStagerTask*>(orig_task), dups);
      break;
    }
    case Method::kUnregisterStager: {
      labstor::CALL_DUPLICATE(reinterpret_cast<UnregisterStagerTask*>(orig_task), dups);
      break;
    }
    case Method::kStageIn: {
      labstor::CALL_DUPLICATE(reinterpret_cast<StageInTask*>(orig_task), dups);
      break;
    }
    case Method::kStageOut: {
      labstor::CALL_DUPLICATE(reinterpret_cast<StageOutTask*>(orig_task), dups);
      break;
    }
  }
}
...
void DupEnd(u32 method, u32 replica, Task *orig_task, Task *dup_task) override {
  switch (method) {
    ...
    case Method::kRegisterStager: {
      labstor::CALL_DUPLICATE_END(replica, reinterpret_cast<RegisterStagerTask*>(orig_task), reinterpret_cast<RegisterStagerTask*>(dup_task));
      break;
    }
    case Method::kUnregisterStager: {
      labstor::CALL_DUPLICATE_END(replica, reinterpret_cast<UnregisterStagerTask*>(orig_task), reinterpret_cast<UnregisterStagerTask*>(dup_task));
      break;
    }
    case Method::kStageIn: {
      labstor::CALL_DUPLICATE_END(replica, reinterpret_cast<StageInTask*>(orig_task), reinterpret_cast<StageInTask*>(dup_task));
      break;
    }
    case Method::kStageOut: {
      labstor::CALL_DUPLICATE_END(replica, reinterpret_cast<StageOutTask*>(orig_task), reinterpret_cast<StageOutTask*>(dup_task));
      break;
    }
  }
}
