...
void Run(u32 method, Task *task, RunContext &rctx) override {
  switch (method) {
    ...
    case Method::kRegisterOp: {
      RegisterOp(reinterpret_cast<RegisterOpTask *>(task), rctx);
      break;
    }
    case Method::kRegisterData: {
      RegisterData(reinterpret_cast<RegisterDataTask *>(task), rctx);
      break;
    }
    case Method::kRunOp: {
      RunOp(reinterpret_cast<RunOpTask *>(task), rctx);
      break;
    }
  }
}
...
void Monitor(u32 mode, Task *task, RunContext &rctx) override {
  switch (task->method_) {
    ...
    case Method::kRegisterOp: {
      MonitorRegisterOp(mode, reinterpret_cast<RegisterOpTask *>(task), rctx);
      break;
    }
    case Method::kRegisterData: {
    ...
    case Method::kRunOp: {
      MonitorRunOp(mode, reinterpret_cast<RunOpTask *>(task), rctx);
      break;
    }
  }
}
