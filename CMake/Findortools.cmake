...
if(NOT TARGET ortools::ortools)
  ...
  foreach(X ${LIB_TO_FIND})
    ...
    if(LIB_${X})
      string(REGEX MATCH ".*glog.*" MATCH_RESULT LIB_${X})
      if(MATCH_RESULT)
        message(STATUS "Adding glog::glog target")
        add_library(glog INTERFACE)
        add_library(glog::glog ALIAS glog)
        target_include_directories(glog INTERFACE ${ORTOOLS_INCLUDE_DIRS})
        target_link_libraries(glog INTERFACE ${LIB_${X}})
      else()
