...
class API {
 public:
  ...
  typedef int (*MPI_Waitall_t)(int count, MPI_Request * req,
                               MPI_Status * status);
  int (*MPI_Waitall)(int count, MPI_Request * req,
                     MPI_Status * status) = nullptr;
  typedef int (*MPI_File_open_t)(MPI_Comm comm, const char * filename,
  ...
  typedef int (*MPI_File_seek_shared_t)(MPI_File fh,
  ...
  int (*MPI_File_read_all)(MPI_File fh, void * buf, int count,
                           MPI_Datatype datatype,
                           MPI_Status * status) = nullptr;
  typedef int (*MPI_File_read_at_all_t)(MPI_File fh, MPI_Offset offset,
                                        void * buf, int count,
                                        MPI_Datatype datatype,
                                        MPI_Status * status);
  int (*MPI_File_read_at_all)(MPI_File fh, MPI_Offset offset, void * buf,
                              ...
                              MPI_Status * status) = nullptr;
  typedef int (*MPI_File_read_at_t)(MPI_File fh, MPI_Offset offset,
                                    void * buf, int count,
  ...
  int (*MPI_File_read_ordered)(MPI_File fh, void * buf, int count,
                               MPI_Datatype datatype,
                               MPI_Status * status) = nullptr;
  typedef int (*MPI_File_read_shared_t)(MPI_File fh, void * buf,
                                        int count, MPI_Datatype datatype,
                                        MPI_Status * status);
  int (*MPI_File_read_shared)(MPI_File fh, void * buf, int count,
                              MPI_Datatype datatype,
                              MPI_Status * status) = nullptr;
  typedef int (*MPI_File_write_all_t)(MPI_File fh, const void * buf,
                                      int count, MPI_Datatype datatype,
                                      MPI_Status * status);
  ...
  int (*MPI_File_write)(MPI_File fh, const void * buf, int count,
                        MPI_Datatype datatype, MPI_Status * status) = nullptr;
  typedef int (*MPI_File_write_ordered_t)(MPI_File fh, const void * buf,
                                          int count, MPI_Datatype datatype,
                                          MPI_Status * status);
  int (*MPI_File_write_ordered)(MPI_File fh, const void * buf, int count,
                                MPI_Datatype datatype,
                                MPI_Status * status) = nullptr;
  typedef int (*MPI_File_write_shared_t)(MPI_File fh, const void * buf,
                                         int count, MPI_Datatype datatype,
                                         MPI_Status * status);
  int (*MPI_File_write_shared)(MPI_File fh, const void * buf, int count,
                               MPI_Datatype datatype,
                               MPI_Status * status) = nullptr;
  typedef int (*MPI_File_iread_at_t)(MPI_File fh, MPI_Offset offset,
                                     void * buf, int count,
                                     MPI_Datatype datatype,
                                     MPI_Request * request);
  ...
  int (*MPI_File_iwrite)(MPI_File fh, const void * buf, int count,
                         MPI_Datatype datatype,
                         MPI_Request * request) = nullptr;
  typedef int (*MPI_File_iwrite_shared_t)(MPI_File fh, const void * buf,
                                          int count, MPI_Datatype datatype,
                                          MPI_Request * request);
  ...
  API() {
    ...
    if (is_intercepted) {
      MPI_Waitall = (MPI_Waitall_t)dlsym(RTLD_NEXT,
                                         "MPI_Waitall");
    } else {
      MPI_Waitall = (MPI_Waitall_t)dlsym(RTLD_DEFAULT,
                                         "MPI_Waitall");
    }
    ...
    if (is_intercepted) {
      MPI_File_open = (MPI_File_open_t)dlsym(RTLD_NEXT,
                                             "MPI_File_open");
    } else {
      MPI_File_open = (MPI_File_open_t)dlsym(RTLD_DEFAULT,
                                             "MPI_File_open");
    }
    ...
    if (is_intercepted) {
      MPI_File_close = (MPI_File_close_t)dlsym(RTLD_NEXT,
                                               "MPI_File_close");
    } else {
      MPI_File_close = (MPI_File_close_t)dlsym(RTLD_DEFAULT,
                                               "MPI_File_close");
    }
    ...
    if (is_intercepted) {
      MPI_File_seek_shared = (MPI_File_seek_shared_t)
          dlsym(RTLD_NEXT, "MPI_File_seek_shared");
    } else {
      MPI_File_seek_shared = (MPI_File_seek_shared_t)
          dlsym(RTLD_DEFAULT, "MPI_File_seek_shared");
    }
    ...
    if (is_intercepted) {
      MPI_File_seek = (MPI_File_seek_t)
          dlsym(RTLD_NEXT, "MPI_File_seek");
    } else {
      MPI_File_seek = (MPI_File_seek_t)
          dlsym(RTLD_DEFAULT, "MPI_File_seek");
    }
    ...
    if (is_intercepted) {
      MPI_File_get_position = (MPI_File_get_position_t)
          dlsym(RTLD_NEXT, "MPI_File_get_position");
    } else {
      MPI_File_get_position = (MPI_File_get_position_t)
          dlsym(RTLD_DEFAULT, "MPI_File_get_position");
    }
    ...
    if (is_intercepted) {
      MPI_File_read_all = (MPI_File_read_all_t)
          dlsym(RTLD_NEXT, "MPI_File_read_all");
    } else {
      MPI_File_read_all = (MPI_File_read_all_t)
          dlsym(RTLD_DEFAULT, "MPI_File_read_all");
    }
    ...
    if (is_intercepted) {
      MPI_File_read_at_all = (MPI_File_read_at_all_t)
          dlsym(RTLD_NEXT, "MPI_File_read_at_all");
    } else {
      MPI_File_read_at_all = (MPI_File_read_at_all_t)
          dlsym(RTLD_DEFAULT, "MPI_File_read_at_all");
    }
    ...
    if (is_intercepted) {
      MPI_File_read_at = (MPI_File_read_at_t)
          dlsym(RTLD_NEXT, "MPI_File_read_at");
    } else {
      MPI_File_read_at = (MPI_File_read_at_t)
          dlsym(RTLD_DEFAULT, "MPI_File_read_at");
    }
    ...
    if (is_intercepted) {
      MPI_File_read = (MPI_File_read_t)
          dlsym(RTLD_NEXT, "MPI_File_read");
    } else {
      MPI_File_read = (MPI_File_read_t)
          dlsym(RTLD_DEFAULT, "MPI_File_read");
    }
    ...
    if (is_intercepted) {
      MPI_File_read_ordered = (MPI_File_read_ordered_t)
          dlsym(RTLD_NEXT, "MPI_File_read_ordered");
    } else {
      MPI_File_read_ordered = (MPI_File_read_ordered_t)
          dlsym(RTLD_DEFAULT, "MPI_File_read_ordered");
    }
    ...
    if (is_intercepted) {
      MPI_File_read_shared = (MPI_File_read_shared_t)
          dlsym(RTLD_NEXT, "MPI_File_read_shared");
    } else {
      MPI_File_read_shared = (MPI_File_read_shared_t)
          dlsym(RTLD_DEFAULT, "MPI_File_read_shared");
    }
    ...
    if (is_intercepted) {
      MPI_File_write_all = (MPI_File_write_all_t)
          dlsym(RTLD_NEXT, "MPI_File_write_all");
    } else {
      MPI_File_write_all = (MPI_File_write_all_t)
          dlsym(RTLD_DEFAULT, "MPI_File_write_all");
    }
    ...
    if (is_intercepted) {
      MPI_File_write_at_all = (MPI_File_write_at_all_t)
          dlsym(RTLD_NEXT, "MPI_File_write_at_all");
    } else {
      MPI_File_write_at_all = (MPI_File_write_at_all_t)
          dlsym(RTLD_DEFAULT, "MPI_File_write_at_all");
    }
    ...
    if (is_intercepted) {
      MPI_File_write_at = (MPI_File_write_at_t)
          dlsym(RTLD_NEXT, "MPI_File_write_at");
    } else {
      MPI_File_write_at = (MPI_File_write_at_t)
          dlsym(RTLD_DEFAULT, "MPI_File_write_at");
    }
    ...
    if (is_intercepted) {
      MPI_File_write = (MPI_File_write_t)
          dlsym(RTLD_NEXT, "MPI_File_write");
    } else {
      MPI_File_write = (MPI_File_write_t)
          dlsym(RTLD_DEFAULT, "MPI_File_write");
    }
    ...
    if (is_intercepted) {
      MPI_File_write_ordered = (MPI_File_write_ordered_t)
          dlsym(RTLD_NEXT, "MPI_File_write_ordered");
    } else {
      MPI_File_write_ordered = (MPI_File_write_ordered_t)
          dlsym(RTLD_DEFAULT, "MPI_File_write_ordered");
    }
    ...
    if (is_intercepted) {
      MPI_File_write_shared = (MPI_File_write_shared_t)
          dlsym(RTLD_NEXT, "MPI_File_write_shared");
    } else {
      MPI_File_write_shared = (MPI_File_write_shared_t)
          dlsym(RTLD_DEFAULT, "MPI_File_write_shared");
    }
    ...
    if (is_intercepted) {
      MPI_File_iread_at = (MPI_File_iread_at_t)
          dlsym(RTLD_NEXT, "MPI_File_iread_at");
    } else {
      MPI_File_iread_at = (MPI_File_iread_at_t)
          dlsym(RTLD_DEFAULT, "MPI_File_iread_at");
    }
    ...
    if (is_intercepted) {
      MPI_File_iread = (MPI_File_iread_t)
          dlsym(RTLD_NEXT, "MPI_File_iread");
    } else {
      MPI_File_iread = (MPI_File_iread_t)
          dlsym(RTLD_DEFAULT, "MPI_File_iread");
    }
    ...
    if (is_intercepted) {
      MPI_File_iread_shared = (MPI_File_iread_shared_t)
          dlsym(RTLD_NEXT, "MPI_File_iread_shared");
    } else {
      MPI_File_iread_shared = (MPI_File_iread_shared_t)
          dlsym(RTLD_DEFAULT, "MPI_File_iread_shared");
    }
    ...
    if (is_intercepted) {
      MPI_File_iwrite_at = (MPI_File_iwrite_at_t)
          dlsym(RTLD_NEXT, "MPI_File_iwrite_at");
    } else {
      MPI_File_iwrite_at = (MPI_File_iwrite_at_t)
          dlsym(RTLD_DEFAULT, "MPI_File_iwrite_at");
    }
    ...
    if (is_intercepted) {
      MPI_File_iwrite = (MPI_File_iwrite_t)
          dlsym(RTLD_NEXT, "MPI_File_iwrite");
    } else {
      MPI_File_iwrite = (MPI_File_iwrite_t)
          dlsym(RTLD_DEFAULT, "MPI_File_iwrite");
    }
    ...
    if (is_intercepted) {
      MPI_File_iwrite_shared = (MPI_File_iwrite_shared_t)
          dlsym(RTLD_NEXT, "MPI_File_iwrite_shared");
    } else {
      MPI_File_iwrite_shared = (MPI_File_iwrite_shared_t)
          dlsym(RTLD_DEFAULT, "MPI_File_iwrite_shared");
    }
    ...
    if (is_intercepted) {
      MPI_File_sync = (MPI_File_sync_t)
          dlsym(RTLD_NEXT, "MPI_File_sync");
    } else {
      MPI_File_sync = (MPI_File_sync_t)
          dlsym(RTLD_DEFAULT, "MPI_File_sync");
    }
