...
void MetadataManager::shm_init(hipc::ShmArchive<MetadataManagerShm> &header,
  ...
  HSHM_MAKE_AR(header_->blob_id_map_, alloc, 10000000)
  HSHM_MAKE_AR(header_->blob_map_, alloc, 10000000)
  HSHM_MAKE_AR(header_->tag_id_map_, alloc, 10000000)
  HSHM_MAKE_AR(header_->tag_map_, alloc, 10000000)
